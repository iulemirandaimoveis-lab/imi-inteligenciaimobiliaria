...
ALTER TABLE public.developments ADD COLUMN IF NOT EXISTS tags                   JSONB DEFAULT '[]'::jsonb;
...
-- ── PARTE 3: Jazz Boulevard ────────────────────────────────────────────────
-- Usa INSERT ... SELECT para obter o developer_id sem blocos PL/pgSQL
...
SELECT
  ...
  '[
    {"id":"fusion-center","name":"Fusion Center","tagline":"Tudo que você precisa num só lugar","description":"13 andares com salas empresariais, lofts, studios e apartamentos com varanda. Lojas no térreo, estacionamento rotativo e áreas comuns exclusivas.","floor_count":13,"image":null},
    {"id":"soul-residence","name":"Soul Residence","tagline":"O tom certo entre sofisticação e aconchego","description":"19 pavimentos com apartamentos de 95,45m² a 167,21m², com vista privilegiada para as Sete Colinas de Garanhuns.","floor_count":19,"image":null}
  ]'::jsonb,

  '[
    {"id":"sala-empresarial","name":"Sala Empresarial","tower":"Fusion Center","tower_id":"fusion-center","category":"comercial","area_from":30.40,"area_to":53.31,"bedrooms":0,"bathrooms":1,"parking":0,"price_from":null,"price_to":null,"images":[],"description":"Salas de 30,40m² a 53,31m² para seus negócios em ritmo de pleno crescimento."},
    {"id":"studio","name":"Studio","tower":"Fusion Center","tower_id":"fusion-center","category":"residencial","area_from":45.77,"area_to":92.31,"bedrooms":1,"bathrooms":1,"parking":1,"price_from":405472,"price_to":974391,"images":[],"description":"Studios de 45,77m² a 92,31m² para morar ou investir com varanda voltada para as colinas."},
    {"id":"loft","name":"Loft","tower":"Fusion Center","tower_id":"fusion-center","category":"residencial","area_from":46.43,"area_to":61.94,"bedrooms":1,"bathrooms":1,"parking":1,"price_from":509778,"price_to":706530,"images":[],"description":"Lofts de 46,43m² a 61,94m² com pé direito duplo e varanda voltada para as colinas da Suíça Pernambucana."},
    {"id":"apartamento-fusion","name":"Apartamento","tower":"Fusion Center","tower_id":"fusion-center","category":"residencial","area_from":60.87,"area_to":92.31,"bedrooms":2,"bathrooms":2,"parking":1,"price_from":550049,"price_to":974391,"images":[],"description":"Apartamentos de 60,87m² a 92,31m² com varanda e vista para as colinas de Garanhuns."},
    {"id":"soul-tipo-cd","name":"Apartamento 95m²","tower":"Soul Residence","tower_id":"soul-residence","category":"residencial","area_from":95.45,"area_to":96.79,"bedrooms":2,"bathrooms":2,"parking":2,"price_from":870765,"price_to":1051872,"images":[],"description":"Apartamentos de 95,45m² a 96,79m² com 2 suítes e vista para as Sete Colinas de Garanhuns."},
    {"id":"soul-tipo-b","name":"Apartamento 120m²","tower":"Soul Residence","tower_id":"soul-residence","category":"residencial","area_from":120.61,"area_to":120.61,"bedrooms":2,"bathrooms":2,"parking":2,"price_from":1110295,"price_to":1329139,"images":[],"description":"Apartamentos de 120,61m² com 2 suítes, ambientes amplos e vista privilegiada para as Sete Colinas."},
    {"id":"soul-tipo-a","name":"Apartamento 167m²","tower":"Soul Residence","tower_id":"soul-residence","category":"residencial","area_from":167.09,"area_to":167.21,"bedrooms":3,"bathrooms":3,"parking":3,"price_from":1538174,"price_to":1841356,"images":[],"description":"167m² de sofisticação absoluta com 3 suítes e vista panorâmica para as Sete Colinas de Garanhuns."}
  ]'::jsonb,

  '{"main":"","gallery":[],"floorPlans":[],"videos":["https://youtube.com/shorts/F04Bu2g4qCE"],"virtualTour":"https://tour.panoee.net/TORRE_SOUL_RESIDENCE","coverVideo":""}'::jsonb
...
-- ── PARTE 4: Após subir o vídeo de capa via backoffice, rode este UPDATE ──
-- Substitua <URL_DO_VIDEO> pela URL pública do Supabase Storage após upload:
--
-- UPDATE public.developments
-- SET
--   cover_video_url = '<URL_DO_VIDEO>',
--   images = images || '{"coverVideo": "<URL_DO_VIDEO>"}'::jsonb
-- WHERE slug = 'jazz-boulevard-garanhuns';
