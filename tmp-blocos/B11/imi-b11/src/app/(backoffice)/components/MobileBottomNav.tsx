...
const GOLD = '#C49D5B'
const DIM = '#4E5669'
const SURFACE = 'rgba(19,22,30,0.96)'
            ...
            >
                <div
                    ...
                    style={{
                        ...
                        boxShadow: '0 -4px 24px rgba(0,0,0,0.40), 0 2px 0 rgba(196,157,91,0.08) inset',
                    }}
                >
                ...
                {open && (
                    <>
                        ...
                        <motion.div
                            ...
                            className="lg:hidden fixed bottom-0 inset-x-0 z-50 rounded-t-3xl overflow-hidden"
                            style={{
                                background: '#13161E',
                        ...
                        >
                            ...
                            >
                                <div className="flex items-center gap-3">
                                    ...
                                    <span className="text-base font-semibold" style={{ color: '#F0F2F5', fontFamily: 'var(--font-playfair), serif' }}>
                                        IMI Atlantis
                                    </span>
                                </div>
                                <motion.button
                                                ...
                                                >
                                                    ...
                                                    >
                                                        <div
                                                            ...
                                                            style={{
                                                                background: active ? 'rgba(196,157,91,0.15)' : 'rgba(255,255,255,0.05)',
                                                            }}
                                                        >
                                                            <item.icon size={15} />
                                                        </div>
