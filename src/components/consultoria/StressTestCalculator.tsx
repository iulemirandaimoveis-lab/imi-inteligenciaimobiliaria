            ...
            <div className="space-y-8 flex-grow">
                <div>
                    ...
                    <input
                        ...
                        className={`w-full h-2 rounded-lg appearance-none cursor-pointer transition-colors duration-500 ${isSafe ? 'bg-[#1A1E2A] [#3B82F6]' : 'bg-[#EF4444]/20 accent-[#EF4444]'}`}
                    />
                </div>
                ...
                <div className={`p-8 rounded-2xl border-2 transition-all duration-500 flex flex-col items-center text-center ${isSafe ? 'bg-[#141420] border-white/[0.05]' : 'bg-[#EF4444]/10 border-[#EF4444]/30 shadow-lg shadow-[#EF4444]/10'}`}>
                    <div className={`w-16 h-16 rounded-full flex items-center justify-center mb-6 ${isSafe ? 'bg-[#1A1E2A] text-[#3B82F6] border border-white/10' : 'bg-[#EF4444]/20 text-[#EF4444] border border-[#EF4444]/30'}`}>
