                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="max-w-2xl">
                        ...
                        <motion.div
                            ...
                            className="inline-flex items-center gap-3 bg-white/[0.04] border border-white/10 px-6 py-3 rounded-full text-[#3B82F6] text-sm font-semibold mb-8 backdrop-blur-sm"
                        >
                        ...
                        >
                            ...
                            <span className="text-[#3B82F6]">Imóveis Internacionais</span>
                        </motion.h1>
                        ...
                        >
                            <a
                                href="#simulator"
                                className="inline-flex items-center justify-center gap-3 h-14 px-8 text-[14px] font-bold uppercase tracking-widest bg-[#1A1E2A] text-white rounded-xl border border-[#21263A] border-l-2 border-[#3B82F6] shadow-[0_8px_32px_rgba(26,26,46,0.15)] hover:bg-[#21263A] transition-all duration-300"
                            >
                                Simular Estratégia
                        ...
                        >
                            {[
                                ...
                                <div key={i} className="flex items-center gap-3">
                                    <CheckCircle className="w-5 h-5 text-[#3B82F6]" strokeWidth={1.5} />
