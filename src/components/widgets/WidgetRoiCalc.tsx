        ...
        <svg width={size} height={size} viewBox={`0 0 ${size} ${size}`}>
            <defs>
                <linearGradient id="capGrad" x1="0" y1="0" x2="1" y2="1">
                    <stop offset="0%" stopColor="var(--accent-400,#C8A44A)" />
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 10 }}>
                    <div>
                        ...
                        <div style={{ fontSize: 28, fontWeight: 700, color: 'var(--accent-400,#C8A44A)', fontFamily: 'var(--font-display,"Playfair Display",serif)', lineHeight: 1 }}>
                            {formatPct(roiTotal)}
                        </div>
                    </div>
                    <div>
            ...
            <div style={{ display: 'flex', gap: 16 }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
                    <div style={{ width: 10, height: 10, borderRadius: 2, background: 'var(--accent-400,#C8A44A)' }} />
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8 }}>
                {[
                    { label: 'Ganho Capital', value: formatBRL(ganhoCapital), color: 'var(--accent-400,#C8A44A)' },
