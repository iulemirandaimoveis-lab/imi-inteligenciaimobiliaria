...
function getLiquidityLabel(score: number): { text: string; color: string } {
    ...
    if (score >= 45) return { text: 'Liquidez Média', color: 'var(--accent-400,#C8A44A)' }
...
function GaugeArc({ value }: { value: number }) {
    ...
    const zoneArcs = [
        ...
        { from: 210 - 96, to: 210 - 168, color: 'var(--accent-400,#C8A44A)', label: '' }, // 40–70: 72°
