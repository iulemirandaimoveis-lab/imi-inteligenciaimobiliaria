                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
                    ...
                    <div className="lg:col-span-5 overflow-hidden">
                        <Link href={`/${lang}`} className="inline-block group mb-8">
                            <span
                                className="text-[28px] font-black tracking-tight text-white group-hover:text-[#3B82F6] transition-colors duration-200"
                        ...
                        {/* Credentials card */}
                        <div className="border-l-[4px] border-[#3B82F6] bg-gradient-to-br from-white/[0.04] to-transparent rounded-r-2xl p-6 lg:p-8 mb-8">
                            <p className="font-bold text-white text-[16px] mb-1">Iule Miranda</p>
                            <p className="text-[#3B82F6] text-[10px] font-bold uppercase tracking-[0.2em] mb-6">
                    ...
                    <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-8 lg:gap-10">
                        {NAV_COLS.map((col) => (
                            <div key={col.title}>
                                <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#3B82F6] mb-5">
                                    {col.title}
                                </h4>
                    ...
                    <div className="flex items-center gap-3">
                        {LANGS.map((l, i) => (
                            <React.Fragment key={l.code}>
                                ...
                                <Link
                                    href={`/${l.code}`}
                                    className={`text-[10px] font-bold uppercase tracking-[0.15em] transition-colors duration-150 ${lang === l.code ? 'text-[#3B82F6]' : 'text-[#495057] hover:text-white'
                                        }`}
                                >
                                    {l.label}
                                </Link>
