...
export function WhatsAppFAB() {
    ...
    // Hide FAB whenever any modal locks body scroll
    useEffect(() => {
        const check = () => {
        ...
        >
            ...
            <a
                ...
                style={{
                    ...
                    alignItems: 'center',
                    justifyContent: 'center',
                    boxShadow: '0 4px 18px rgba(37,211,102,0.45), 0 2px 8px rgba(0,0,0,0.25)',
                    transition: 'transform 0.2s ease, box-shadow 0.2s ease',
                    textDecoration: 'none',
                }}
                onMouseEnter={e => {
                    e.currentTarget.style.transform = 'scale(1.1)'
                    e.currentTarget.style.boxShadow = '0 6px 24px rgba(37,211,102,0.55), 0 3px 10px rgba(0,0,0,0.3)'
                }}
                onMouseLeave={e => {
                    e.currentTarget.style.transform = 'scale(1)'
                    e.currentTarget.style.boxShadow = '0 4px 18px rgba(37,211,102,0.45), 0 2px 8px rgba(0,0,0,0.25)'
                }}
            >
