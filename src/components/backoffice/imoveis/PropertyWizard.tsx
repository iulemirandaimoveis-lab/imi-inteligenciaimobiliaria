                    ...
                    {currentStep === 0 && (
                        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <Select label="Construtora" {...register('developer_id')} error={errors.developer_id?.message} options={[
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                <Select label="Tipo" {...register('property_type')} error={errors.property_type?.message} options={[
                                ...
                                <Select label="Status da Obra" {...register('status')} error={errors.status?.message} options={[
