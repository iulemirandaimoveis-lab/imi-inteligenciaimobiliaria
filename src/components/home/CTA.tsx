...
export default function CTA({ dict }: CTAProps) {
    ...
    return (
        <section className="py-24 bg-[#0D0F14] relative overflow-hidden">
            ...
            <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(circle at center, #3B82F6 0%, transparent 70%)', filter: 'blur(100px)' }} />
            ...
            <div className="container-custom text-center relative z-10">
                ...
                <Button
                    size="lg"
                    className="h-16 px-12 text-lg font-bold bg-[#1A1E2A] text-white hover:bg-[#21263A] border border-[#21263A] border-l-4 border-l-[#3B82F6] border-r-4 border-r-[#E53935] shadow-[0_8px_32px_rgba(26,26,46,0.15)] rounded-2xl transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(26,26,46,0.25)]"
