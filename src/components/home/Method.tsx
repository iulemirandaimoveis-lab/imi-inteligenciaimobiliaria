...
export default function Method({ dict }: MethodProps) {
    ...
    return (
        <section className="relative bg-[#141420] py-20 lg:py-28 overflow-hidden">
            ...
            <div className="relative z-10 max-w-[800px] mx-auto px-5 sm:px-6 lg:px-8 text-center">
                {/* Eyebrow */}
                <div className="flex items-center justify-center gap-3 mb-8">
                    <div className="w-8 h-px bg-[#C49D5B]/40" />
                    <span className="text-[#C49D5B] text-[11px] font-bold uppercase tracking-[0.25em]">{dict.method_pre}</span>
                    <div className="w-8 h-px bg-[#C49D5B]/40" />
                </div>

                {/* Quote mark */}
                <div className="text-[100px] sm:text-[120px] leading-none text-[#C49D5B]/10 font-serif absolute top-8 left-1/2 -translate-x-1/2 select-none pointer-events-none" aria-hidden="true">&ldquo;</div>

                <h2 className="relative z-10 text-[24px] sm:text-[32px] lg:text-[44px] font-black text-white leading-[1.15] mb-10 px-2" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>
                    {dict.method_title}
                </h2>
