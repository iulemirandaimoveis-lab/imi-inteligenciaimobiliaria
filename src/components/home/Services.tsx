...
export default function Services({ dict }: ServicesProps) {
    ...
    return (
        <section className="py-16 lg:py-20" style={{ background: 'var(--bg-void)' }}>
            <div className="max-w-[1280px] mx-auto px-6 lg:px-8">
                ...
                >
                    <div className="w-8 h-px" style={{ background: 'var(--text-tertiary)' }} />
                        ...
                        >
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    ...
                                    <div className="flex items-center gap-2 text-[12px] font-semibold group-hover:gap-3 transition-all duration-200" style={{ color: 'var(--text-secondary)', fontFamily: 'var(--font-sans)' }}>
