        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-5">
          {services.map((item, i) => (
            ...
            >
              <Link
                href={item.href}
                className="group relative block bg-white rounded-2xl p-7 border border-[#E9ECEF] hover:border-[#C49D5B]/40 hover:shadow-[0_8px_32px_rgba(196,157,91,0.10)] transition-all duration-300 overflow-hidden"
              >
                {/* Background gradient */}
