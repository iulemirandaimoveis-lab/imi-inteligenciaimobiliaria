        ...
        <div className="rounded-2xl overflow-hidden bg-white border border-gray-100 shadow-sm">
            ...
            <div className="p-5">
                ...
                <div className="flex items-center gap-4 mb-4">
                    <div className="relative w-14 h-14 rounded-xl overflow-hidden flex-shrink-0 bg-[#102A43]/5 flex items-center justify-center border border-gray-100">
                        {broker.avatar_url ? (
                            <Image
                            ...
                            <span className="text-sm font-bold text-[#102A43]/60">
                                {initials}
                            </span>
                        )}
                    </div>
