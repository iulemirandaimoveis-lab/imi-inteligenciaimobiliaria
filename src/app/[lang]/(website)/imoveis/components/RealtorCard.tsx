        ...
        >
            ...
            <div className={`${compact ? 'p-3' : 'p-5'} flex flex-col flex-1`}>
                ...
                <div className={`flex flex-col items-center text-center gap-2 ${compact ? 'mb-3' : 'mb-5'}`}>
                    ...
                    <div
                        className={`relative ${compact ? 'w-14 h-14' : 'w-[88px] h-[88px]'} rounded-full overflow-hidden flex-shrink-0 flex items-center justify-center`}
                        style={{
                            background: '#F0EDE5',
                    ...
                    >
                        {broker.avatar_url ? (
                            ...
                            <span className={`${compact ? 'text-base' : 'text-xl'} font-bold`} style={{ color: '#0B1928' }}>
                                {initials}
                            </span>
                        )}
                    </div>
                    ...
                    <div>
                        <h4
                            className={`${compact ? 'text-[13px]' : 'text-[17px]'} font-bold`}
                ...
                {/* Response time */}
                <div
                    className={`flex items-center gap-1.5 ${compact ? 'mb-3 px-2 py-1.5' : 'mb-4 px-3 py-2'} rounded-lg`}
                ...
                <div className={compact ? 'space-y-2 mt-auto pt-2' : 'space-y-2.5'}>
                    {whatsappUrl && (
                        <a
                            ...
                            className={`relative flex items-center justify-center gap-1.5 w-full ${compact ? 'h-9 rounded-lg text-[10px]' : 'h-12 rounded-xl text-[11px]'} font-bold uppercase tracking-wider transition-all duration-200 overflow-hidden hover:opacity-90 active:scale-[0.98]`}
                            style={{
                                background: '#0B1928',
                                color: '#fff',
                                textDecoration: 'none',
                        ...
                        >
                            ...
                            {compact ? firstName : `Falar com ${firstName}`}
