...
const TIPO_CFG: Record<string, { label: string; icon: React.ElementType; color: string }> = {
    ...
    artigo:     { label: 'Artigo',     icon: FileText,  color: '#C8A44A' },
            ...
            <section style={{ background: '#0D1117' }} className="relative overflow-hidden">
                ...
                <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-24 lg:py-32 relative z-10">
                    <div className="flex items-center gap-3 mb-6">
                        <div className="h-px w-10" style={{ background: '#C8A44A' }} />
                        <span className="text-[11px] font-bold uppercase tracking-[0.22em]" style={{ color: '#C8A44A' }}>Inteligência de Mercado</span>
                    </div>
                ...
                {items.length === 0 ? (
                    <div className="text-center py-24">
                        <div className="w-20 h-20 rounded-3xl mx-auto mb-6 flex items-center justify-center" style={{ background: '#F0F4F8' }}>
                            <BookOpen className="w-9 h-9" style={{ color: '#C8A44A' }} strokeWidth={1.5} />
                        </div>
                    ...
                    <>
                        ...
                        <div className="mt-16 rounded-3xl p-8 md:p-10 lg:p-14 text-center" style={{ background: '#0D1117' }}>
                            <p className="text-[11px] font-bold uppercase tracking-[0.22em] mb-4" style={{ color: '#C8A44A' }}>Newsletter</p>
