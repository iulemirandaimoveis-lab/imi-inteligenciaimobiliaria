    ...
    return (
        <main className="bg-[#0D0F14] min-h-screen">
            ...
            <section className="relative bg-[#141420] text-white pt-24 pb-20 md:pt-32 md:pb-28 overflow-hidden border-b border-white/[0.05]">
                <div className="absolute top-0 right-0 w-1/3 h-full bg-[#C49D5B]/5 -skew-x-12 translate-x-1/4" />
                <div className="container-custom relative z-10">
                    ...
                    >
                        <motion.div variants={slideUp} className="flex items-center gap-3 mb-6">
                            <div className="w-12 h-px bg-[#C49D5B]" />
                            <span className="text-[#C49D5B] font-bold uppercase tracking-[0.25em] text-[11px]">Fale Conosco</span>
                        </motion.div>
                        <motion.h1 variants={slideUp} className="font-display text-4xl sm:text-5xl lg:text-7xl font-bold mb-8 tracking-tight leading-tight text-white">
                            Atendimento Técnico <br /><span className="text-[#C49D5B] italic">Personalizado</span>
                        </motion.h1>
                    ...
                    >
                        {contactInfo.map((item, index) => (
                            <motion.div
                                key={index}
                                variants={slideUp}
                                className="p-8 sm:p-10 rounded-3xl bg-[#141420] border border-white/[0.05] transition-all duration-300 group hover:border-[#C49D5B]/30 hover:shadow-[0_8px_32px_rgba(196,157,91,0.1)]"
                            >
                                <div className="w-14 h-14 bg-[#1A1E2A] text-[#C49D5B] rounded-2xl flex items-center justify-center mb-8 group-hover:scale-110 transition-transform border border-white/[0.05]">
                                ...
                                {item.link ? (
                                    <a
                                        href={item.link}
                                        className="text-[#9CA3AF] leading-relaxed text-sm hover:text-[#C49D5B] transition-colors break-words"
                                    >
                                        {item.content}
                                    </a>
                                ) : (
                        ...
                        >
                            <div className="text-center mb-12">
                                <h2 className="font-display text-3xl sm:text-4xl font-bold text-white mb-4">
                                    Envie sua <span className="text-[#C49D5B] italic">Mensagem</span>
                                </h2>
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6">
                                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full h-12 px-4 rounded-xl bg-[#0D0F14] border border-white/10 text-white text-sm placeholder:text-[#4B5563] focus:border-[#C49D5B]/50 focus:ring-1 focus:ring-[#C49D5B]/30 outline-none transition-all disabled:opacity-50"
                                        />
                                    </div>
                                    <div>
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        disabled={isSubmitting}
                                        rows={5}
                                        className="w-full px-4 py-3 rounded-xl bg-[#0D0F14] border border-white/10 text-white text-sm placeholder:text-[#4B5563] focus:border-[#C49D5B]/50 focus:ring-1 focus:ring-[#C49D5B]/30 outline-none transition-all resize-none disabled:opacity-50"
                                    />
                                </div>
                                ...
                                <button
                                    type="submit"
                                    disabled={isSubmitting}
                                    className="w-full h-14 rounded-xl bg-[#C49D5B] text-[#0D0F14] font-bold text-sm uppercase tracking-wider flex items-center justify-center gap-2 hover:bg-[#D4A96A] transition-all disabled:opacity-50 shadow-[0_4px_14px_rgba(196,157,91,0.3)]"
                                >
                                    {isSubmitting ? (
                                        <>
            ...
            <section className="bg-[#141420] text-white py-20 md:py-32 text-center relative overflow-hidden border-t border-white/[0.05]">
                <div className="absolute inset-0 opacity-[0.05]" style={{ backgroundImage: 'radial-gradient(circle at center, #C49D5B 0%, transparent 60%)', filter: 'blur(80px)' }} />
                <div className="container-custom relative z-10">
                    <motion.div
                    ...
                    >
                        <h2 className="font-display text-3xl sm:text-4xl md:text-5xl font-bold mb-6 text-white tracking-tight">
                            Respostas <span className="text-[#C49D5B] italic">Imediatas</span>
                        </h2>
                        ...
                        <a
                            ...
                            className="inline-flex items-center gap-3 h-16 px-10 text-lg font-bold bg-[#1A1E2A] text-white hover:bg-[#21263A] border border-[#21263A] border-l-4 border-l-[#C49D5B] rounded-2xl transition-all duration-300 hover:-translate-y-1 shadow-[0_8px_32px_rgba(196,157,91,0.15)] hover:shadow-[0_12px_40px_rgba(196,157,91,0.25)]"
                        >
