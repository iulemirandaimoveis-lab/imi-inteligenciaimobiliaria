                    ...
                    <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-6">
                        <div>
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-navy-300 font-bold uppercase tracking-[0.25em] text-[11px]">Inteligência · Relatórios</span>
                            </div>
                            <h1 className="font-display text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-white mb-3">
                                Estudos <span className="text-navy-300 italic">Técnicos</span>
                            </h1>
                            <p className="text-white/50 text-sm sm:text-base font-light leading-relaxed max-w-xl">
                        ...
                        <div className="text-right shrink-0">
                            ...
                            <p className="text-white/50 text-xs mt-0.5">relatórios disponíveis</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-12 md:py-16">
                <div className="container-custom space-y-5">
                    {reports.map((report) => (
                        <div
                            key={report.id}
                            className="group rounded-2xl bg-navy-950 border border-white/[0.05] hover:border-navy-600/40 transition-colors overflow-hidden"
                        >
                            <div className="p-6 sm:p-8 flex flex-col sm:flex-row gap-6">
                                {/* Ícone */}
                                <div className="w-14 h-14 sm:w-16 sm:h-16 shrink-0 bg-navy-800 text-navy-300 rounded-2xl flex items-center justify-center border border-white/[0.05] group-hover:scale-105 transition-transform">
                                ...
                                <div className="flex-1 min-w-0">
                                    ...
                                    <h2 className="font-display text-xl sm:text-2xl font-bold text-white mb-3 group-hover:text-navy-100 transition-colors">
                                        {report.title}
                                    </h2>
                                    {report.summary && (
                                ...
                                <div className="flex sm:flex-col justify-end items-end gap-3 shrink-0">
                                    {report.pdf_url ? (
                                        <a
                                            ...
                                            className="flex items-center gap-2 h-10 px-5 rounded-xl bg-navy-800 text-white font-bold text-xs uppercase tracking-wider hover:bg-navy-700 transition-all shadow-[0_2px_8px_rgba(16,42,67,0.4)]"
                                        >
                                            <Download className="w-3.5 h-3.5" />
                                            Baixar PDF
                                        </a>
                                    ) : (
                                        <span className="flex items-center gap-2 h-10 px-5 rounded-xl border border-white/[0.08] text-white/50 font-bold text-xs uppercase tracking-wider cursor-not-allowed opacity-50">
                                            <Download className="w-3.5 h-3.5" />
                                            Em breve
                                        </span>
                                    )}
                    ...
                    <div className="p-8 sm:p-10 rounded-3xl bg-navy-950 border border-white/[0.05]">
                        <div className="flex flex-col sm:flex-row items-center justify-between gap-6">
                            <div className="flex items-center gap-5">
                                <div className="w-12 h-12 bg-navy-800 text-navy-300 rounded-2xl flex items-center justify-center border border-white/[0.05]">
                                    <BookOpen className="w-5 h-5" strokeWidth={1.5} />
                                </div>
                                <div>
                                    <h3 className="font-display text-xl font-bold text-white">Biblioteca de Ebooks</h3>
                                    <p className="text-white/50 text-sm font-light mt-0.5">Publicações educacionais da Iule Miranda</p>
                                </div>
                            </div>
                            <Link
            ...
            <section className="bg-navy-950 py-16 border-t border-white/[0.05]">
                <div className="container-custom text-center">
                    <h2 className="font-display text-2xl sm:text-3xl font-bold text-white mb-4">
                        Precisa de um <span className="text-navy-300 italic">estudo personalizado</span>?
                    </h2>
