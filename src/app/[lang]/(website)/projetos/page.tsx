...
export const metadata: Metadata = {
    ...
    openGraph: {
        title: 'Projetos IMI — Empreendimentos de Alto Padrão',
...
// ── Page ──────────────────────────────────────────────────────
export default async function ProjetosWebsitePage({
    params,
}: {
    params: { lang: string }
}) {
    ...
    const sttD = STATUS_CONFIG[destaque.status]
                    ...
                    <div className={`relative overflow-hidden rounded-3xl bg-gradient-to-br ${destaque.cor} text-white`}>
                        ...
                        <div className="relative z-10 grid lg:grid-cols-2 gap-0">
                            ...
                            <div className="p-8 md:p-10 lg:p-14 flex flex-col justify-center">
                                <div className="flex items-center gap-3 mb-6">
                                    <span
                                        className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider px-3 py-1.5 rounded-full border"
                                        style={{ background: sttD.badgeBg, borderColor: sttD.badgeBorder, color: sttD.badgeColor }}
                                    >
                            ...
                            <div className="hidden lg:flex items-center justify-center p-10 lg:p-14">
                                <div className="w-full max-w-sm">
                                    <div
                                        className="aspect-[4/5] rounded-2xl relative overflow-hidden border border-white/10"
                    ...
                    <div className="grid md:grid-cols-2 gap-5">
                        {outros.map((p) => {
                            ...
                            return (
                                ...
                                >
                                    {/* Header visual */}
                                    <div className={`h-28 md:h-32 bg-gradient-to-br ${p.cor} relative flex items-center justify-center`}>
                                        <Building2 size={40} className="text-white/10" />
                                        <span
                                            className="absolute top-4 left-4 flex items-center gap-1.5 text-xs font-semibold px-2.5 py-1 rounded-full border"
                                            style={{ background: stt.badgeBg, borderColor: stt.badgeBorder, color: stt.badgeColor }}
                                        >
                                            <span className="w-1.5 h-1.5 rounded-full" style={{ background: stt.dotColor }} />
                                            {p.statusLabel}
                                        </span>
                                    ...
                                    <div className="p-6">
                                        ...
                                        <h3 className="font-bold text-xl text-gray-900 mb-1" style={{ fontFamily: "'Playfair Display', Georgia, serif" }}>{p.nome}</h3>
