    ...
    return (
        <main className="bg-[#0D0F14] min-h-screen">
            ...
            <section className="bg-[#141420] text-white pt-24 pb-20 md:pt-32 md:pb-28 relative overflow-hidden">
                <div className="absolute top-0 right-0 w-1/2 h-full bg-[#C49D5B]/5 -skew-x-12 translate-x-1/2" />
                <div className="container-custom relative z-10">
                    ...
                    >
                        <motion.div variants={slideUp} className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-[#C49D5B] font-bold uppercase tracking-[0.3em] text-xs">Parceiros</span>
                        </motion.div>
                        <motion.h1 variants={slideUp} className="font-display text-4xl md:text-6xl lg:text-7xl font-bold mb-6 tracking-tight leading-tight">
                            Nossas <br /><span className="text-[#C49D5B] italic">Construtoras Parceiras</span>
                        </motion.h1>
                        ...
                        {developers.map((dev, index) => (
                            ...
                            >
                                ...
                                <div className="p-6 flex flex-col flex-1 relative z-10">
                                    <h3 className="font-display font-bold text-xl text-white mb-2 group-hover:text-[#C49D5B] transition-colors">
                                        {dev.name}
                                    </h3>

                                    {(dev.city || dev.state) && (
                                        <div className="flex items-center gap-2 text-[#9CA3AF] text-sm mb-4">
                                            <MapPin className="w-4 h-4 text-[#C49D5B]" />
                ...
                <div className="container-custom text-center">
                    ...
                    >
                        <h2 className="font-display text-3xl md:text-4xl font-bold text-white mb-4">
                            Representa uma <span className="text-[#C49D5B] italic">construtora?</span>
                        </h2>
