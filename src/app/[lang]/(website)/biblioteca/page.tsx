...
const CATALOG_SEED: Omit<Ebook, 'id'>[] = [
    ...
    { slug: 'livro-03-avaliacao-processos-judiciais', title: 'Avaliação Judicial de Imóveis', subtitle: 'Perícia, Laudos e Defesa Técnica em Litígios Imobiliários', description: 'Tudo sobre laudos periciais para processos judiciais e arbitragem imobiliária.', cover_image: null, amazon_link: null, amazon_url: null, pilar: 'avaliacao', publication_status: 'publicado', featured: false, sort_order: 3, release_date: '2026-03-22' },
    { slug: 'livro-04-avaliar-terrenos-lotes', title: 'Avaliação de Terrenos Urbanos', subtitle: 'Do Lote Vazio ao Potencial Construtivo', description: 'Metodologia completa para avaliação de terrenos urbanos: zoneamento, potencial construtivo e incorporação.', cover_image: null, amazon_link: null, amazon_url: null, pilar: 'avaliacao', publication_status: 'publicado', featured: false, sort_order: 4, release_date: '2026-03-22' },
    { slug: 'livro-05-engenharia-avaliacoes-simplificada', title: 'Engenharia de Avaliações', subtitle: 'Estatística, Modelagem e Ciência Aplicada ao Valor Imobiliário', description: 'Fundamentos técnicos da ABNT NBR 14653 com estatística e regressão aplicadas.', cover_image: null, amazon_link: null, amazon_url: null, pilar: 'avaliacao', publication_status: 'publicado', featured: false, sort_order: 5, release_date: '2026-03-22' },
    ...
    // Livro 28 — Avaliação Mercadológica (João Diniz Marcello)
    { slug: 'livro-28-avaliacao-mercadologica-joao-diniz', title: 'Avaliação Mercadológica de Imóveis', subtitle: 'Legislações, Conceitos, Práticas — João Diniz Marcello', description: 'Referência técnica clássica sobre avaliação mercadológica imobiliária. 347 páginas, 21 capítulos, ISBN 978-85-7146-152-9.', cover_image: null, amazon_link: null, amazon_url: null, pilar: 'avaliacao', publication_status: 'publicado', featured: true, sort_order: 28, release_date: '2026-03-22' },
