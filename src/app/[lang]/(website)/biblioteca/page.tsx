...
const CATALOG_SEED: Omit<Ebook, 'id'>[] = [
    // Pilar 1 — Avaliação
    { slug: 'avaliacao-imoveis-pratica', title: 'Avaliação de Imóveis na Prática', subtitle: 'Método Comparativo Explicado', description: 'Guia prático sobre o método comparativo de dados de mercado para avaliação imobiliária.', cover_image: null, amazon_link: null, amazon_url: null, pilar: 'avaliacao', publication_status: 'em_breve', featured: true, sort_order: 1, release_date: null },
