          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                required
                className="w-full h-11 px-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3B82F6]"
                style={inputStyle}
              />
            </div>
            <div>
              ...
              <div className="flex-1">
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  <input
                    ...
                    onChange={handleChange}
                    className="w-5 h-5 rounded accent-[#3B82F6]"
                  />
          ...
          <div className="space-y-5">
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                className="w-full px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#3B82F6] resize-none"
                style={inputStyle}
