          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                required
                className="w-full h-11 px-4 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#C49D5B]"
                style={inputStyle}
              />
            </div>
            <div>
          ...
          <div className="space-y-5">
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                className="w-full px-4 py-3 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#C49D5B] resize-none"
                style={inputStyle}
