          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              ...
              <input
                ...
                required
                className="w-full h-11 px-4 rounded-[6px] focus:outline-none focus:ring-2 focus:ring-[rgba(200,164,74,.25)]"
                style={inputStyle}
              />
            </div>
            <div>
          ...
          <div className="space-y-5">
            <div>
              ...
              <textarea
                ...
                onChange={handleChange}
                rows={3}
                className="w-full px-4 py-3 rounded-[6px] focus:outline-none focus:ring-2 focus:ring-[rgba(200,164,74,.25)] resize-none"
                style={inputStyle}
