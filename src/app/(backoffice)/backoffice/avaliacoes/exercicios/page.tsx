      ...
      <div className="max-w-2xl mx-auto space-y-4 pb-20">
        ...
        <div className="rounded-lg p-6 space-y-5" style={{ background: T.surface, border: `1px solid ${T.border}` }}>
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {current.normaRef && (
              <span className="text-xs px-2 py-0.5 rounded-[6px] font-mono" style={{ background: 'rgba(61,111,255,0.12)', color: 'var(--accent-400, #3D6FFF)' }}>
                {current.normaRef}
              </span>
            )}
          </div>
          ...
          {revealed && (
            <div className="p-4 rounded-lg text-sm" style={{ background: 'rgba(61,111,255,0.08)', border: '1px solid rgba(61,111,255,0.20)' }}>
              <p className="font-semibold mb-1" style={{ color: 'var(--accent-400, #3D6FFF)' }}>Explicação</p>
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-20">
      ...
      <div className="grid grid-cols-3 gap-3">
        {[
          { label: 'Questões', value: EXERCICIOS.length, icon: BookOpen, bg: 'rgba(61,111,255,0.12)', color: 'var(--accent-400, #3D6FFF)' },
              ...
              try {
                ...
                return (
                  <div className="space-y-3 p-3 rounded-lg" style={{ background: T.elevated }}>
                    ...
                    {parsed.normaRef && (
                      <span className="inline-block text-xs px-2 py-0.5 rounded font-mono" style={{ background: 'rgba(61,111,255,0.12)', color: 'var(--accent-400, #3D6FFF)' }}>
                        {parsed.normaRef}
                      </span>
                    )}
                    ...
                    <div className="p-2 rounded text-xs" style={{ background: 'rgba(61,111,255,0.08)', border: '1px solid rgba(61,111,255,0.15)', color: T.textMuted }}>
                      {parsed.explicacao}
                    </div>
                  </div>
                )
