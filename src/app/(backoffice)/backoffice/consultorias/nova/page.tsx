              ...
              {[
                ...
                <div key={f.k}>
                  ...
                  <input value={(form as any)[f.k]} onChange={e => set(f.k, e.target.value)}
                    ...
                    className="w-full h-10 px-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#334E68]" />
                </div>
              ))}
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <select value={form.estado} onChange={e => set('estado', e.target.value)}
                    className="w-full h-10 px-3 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#334E68] bg-white">
          ...
          <>
            ...
            <div className="space-y-2">
              ...
              {TIPOS.map(t => (
                <button key={t.v} onClick={() => set('tipo', t.v)}
                  className={`w-full text-left p-3 rounded-xl border transition-all ${form.tipo === t.v ? 'border-[#334E68] bg-amber-50' : 'border-gray-200 hover:border-gray-300'}`}>
            ...
            <div>
              ...
              <textarea value={form.descricao} onChange={e => set('descricao', e.target.value)}
                ...
                className="w-full px-3 py-2 border border-gray-200 rounded-xl text-sm focus:outline-none focus:border-[#334E68] resize-none" />
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <select value={form.forma_pagamento} onChange={e => set('forma_pagamento', e.target.value)}
                  className="w-full h-10 px-3 border border-gray-200 rounded-xl text-sm bg-white focus:outline-none focus:border-[#334E68]">
