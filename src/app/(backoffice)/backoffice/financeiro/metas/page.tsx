            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-2xl border border-gray-100 p-6 flex flex-col">
                    <div className="flex items-center justify-between mb-6">
                        ...
                        <button className="text-[#C49D5B] text-sm font-medium hover:underline flex items-center gap-1">
            ...
            <div>
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                        <Target size={20} className="text-[#C49D5B]" />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-6">
                    {METAS_ATUAIS.map(meta => {
                        ...
                        return (
                            <div key={meta.id} className={`bg-white rounded-2xl border transition-all hover:border-[#C49D5B]/30 hover:shadow-lg hover:shadow-[#C49D5B]/5 ${isAchieved ? 'border-emerald-100' : 'border-gray-100'}`}>
                                <div className="p-6">
                                ...
                                <div className="border-t border-gray-50 bg-gray-50/50 p-4 rounded-b-2xl flex items-center justify-between">
                                    ...
                                    <button className="text-sm text-[#C49D5B] font-semibold hover:text-[#b08a4a] transition-colors flex items-center gap-1">
