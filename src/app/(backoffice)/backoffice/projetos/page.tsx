        ...
        <div className={T.page}>
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6 space-y-6">
                ...
                <div className="grid grid-cols-2 xl:grid-cols-4 gap-3">
                    {[
                        { l: 'VGV Total Portfólio', v: fmtCurrency(totalVGV), icon: DollarSign, color: '#C49D5B' },
                    ...
                    {['todos', 'estruturacao', 'lancamento', 'obras', 'pronto'].map(s => (
                        <button key={s} onClick={() => setFiltro(s)}
                            className={`h-8 px-3 rounded-xl text-xs font-medium whitespace-nowrap transition-colors border ${filtro === s
                                ? 'bg-[#C49D5B] text-white border-[#C49D5B]'
                                        ...
                                        <div>
                                            ...
                                            <div className="h-2 bg-white/5 rounded-full overflow-hidden">
                                                <div className="h-full rounded-full transition-all"
                                                    style={{
                                                        width: `${pct}%`,
                                                        backgroundColor: pct >= 75 ? '#22C55E' : pct >= 30 ? '#C49D5B' : '#3B82F6',
                                                    }} />
                                            </div>
                                        </div>
