        ...
        <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="rounded-lg p-6 space-y-5" style={{ background: T.surface, border: `1px solid ${T.border}` }}>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div className="md:col-span-2">
                            ...
                            <input type="text"
                                className="w-full h-11 px-4 rounded-[6px] text-sm outline-none focus:ring-2 focus:ring-[#334E68]"
                                style={inputStyle}
                        ...
                        <div>
                            ...
                            <select className="w-full h-11 px-4 rounded-[6px] text-sm outline-none focus:ring-2 focus:ring-[#334E68]"
                                style={inputStyle}
                        ...
                        <div className="md:col-span-2">
                            ...
                            <textarea
                                className="w-full px-4 py-3 rounded-[6px] text-sm resize-none outline-none focus:ring-2 focus:ring-[#334E68]"
                                style={inputStyle}
                                rows={4}
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="text"
                                    className="w-full h-11 pl-9 pr-4 rounded-[6px] text-sm outline-none focus:ring-2 focus:ring-[#334E68]"
                                    style={inputStyle}
            ...
            <div className="flex items-center justify-between">
                <button
                    ...
                    className="h-11 px-6 rounded-[6px] text-sm font-medium transition-colors disabled:opacity-40"
