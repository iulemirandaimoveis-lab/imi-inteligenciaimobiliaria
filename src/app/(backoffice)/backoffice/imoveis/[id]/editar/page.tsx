    ...
    <div className="max-w-6xl mx-auto space-y-0" style={{ paddingTop: isMobile ? 72 : undefined, paddingBottom: isMobile ? 96 : undefined }}>
      ...
      {isMobile && (
        <div style={{
          ...
          borderBottom: '1px solid rgba(200,164,74,.12)',
      ...
      {isMobile && (
        <div style={{
          ...
          borderTop: '1px solid rgba(200,164,74,.12)',
          padding: '12px 16px',
          ...
          {currentTabIndex > 0 && (
            <button
              ...
              style={{
                ...
                borderRadius: 6, background: 'rgba(200,164,74,.08)',
                border: '1px solid rgba(200,164,74,.25)', color: 'var(--accent-400)',
