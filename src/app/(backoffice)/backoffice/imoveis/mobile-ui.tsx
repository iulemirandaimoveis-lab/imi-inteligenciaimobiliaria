  ...
  const btn = (
    <button
      ...
      style={{
        ...
        background: isPrimary ? '#0A1624' : active ? `rgba(200,164,74,0.12)` : 'transparent',
...
export function MobileSearchBar({ value, onChange, placeholder = 'Buscar...', autoFocus }: MobileSearchBarProps) {
  ...
  return (
    <div style={{
      ...
      border: `1px solid ${focused ? 'rgba(200,164,74,0.5)' : 'var(--border-subtle)'}`,
      borderRadius: 6,
      padding: '0 14px',
        ...
        return (
          <button
            ...
            style={{
              ...
              borderRadius: 6,
              background: isActive ? 'var(--nav-active)' : 'rgba(200,164,74,0.08)',
              border: `1px solid ${isActive ? 'var(--nav-active)' : 'rgba(200,164,74,0.2)'}`,
          ...
          >
            {chip.icon && (
              <span style={{ display: 'flex', alignItems: 'center', color: isActive ? '#fff' : 'var(--nav-active)' }}>
                {chip.icon}
              </span>
            )}
            {chip.label}
    ...
    >
      <div
        ...
        style={{
          ...
          borderTop: `1px solid rgba(200,164,74,0.22)`,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <Building2 size={32} style={{ color: 'rgba(200,164,74,0.4)' }} />
      </div>
      <div>
        <div style={{
          fontFamily: 'var(--font-serif)',
          ...
          <Link key={item.href} href={item.href} style={{ flex: 1, textDecoration: 'none' }}>
            <div
              ...
              style={{
                ...
                color: active ? 'var(--nav-active)' : 'var(--text-tertiary)',
        ...
        return (
          <button
            ...
            style={{
              ...
              borderRadius: 6,
              background: isActive ? 'rgba(200,164,74,0.15)' : 'transparent',
              border: `1px solid ${isActive ? T.gold : 'rgba(200,164,74,0.15)'}`,
  ...
  return (
    <button
      ...
      style={{
        ...
        border: `1px solid ${count > 0 ? T.gold : 'rgba(200,164,74,0.25)'}`,
        color: T.gold,
        fontFamily: 'var(--font-sans)',
