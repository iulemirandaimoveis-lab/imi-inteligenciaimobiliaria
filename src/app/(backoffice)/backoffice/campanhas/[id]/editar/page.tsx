            ...
            <div className="pt-6 space-y-6" style={{ borderTop: `1px solid ${T.border}` }}>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 rounded-[6px] text-sm outline-none focus:ring-2 focus:ring-[var(--accent-400)] resize-none transition-all"
                  style={inputStyle}
                />
              </div>
              {/* Faixa Etária */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full h-10 px-3 rounded-[6px] text-sm outline-none focus:ring-2 focus:ring-[var(--accent-400)] transition-all"
                      style={inputStyle}
                    />
                  </div>
                  <div>
