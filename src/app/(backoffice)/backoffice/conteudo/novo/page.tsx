            ...
            <div className="space-y-2">
              {TIPOS_CONTEUDO.map(t => {
                ...
                return (
                  ...
                  >
                    <div style={{ width: '38px', height: '38px', borderRadius: '6px', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, background: t.bg, color: t.color }}>
                      <Icon size={19} />
                    </div>
                    <div>
          ...
          {!preview ? (
            ...
            <div className="rounded-lg p-10 min-h-[600px] relative overflow-hidden" style={{ background: T.surface, border: `1px solid ${T.border}` }}>
              ...
              <div className="flex items-center gap-3 mb-8">
                <div style={{ width: '40px', height: '40px', borderRadius: '6px', display: 'flex', alignItems: 'center', justifyContent: 'center', background: tipoAtual.bg, color: tipoAtual.color }}>
                  <TipoIcon size={20} />
                </div>
                <div>
