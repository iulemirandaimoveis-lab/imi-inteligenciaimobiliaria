...
function SimuladorCredito() {
  ...
  const inputS: React.CSSProperties = {
    ...
    height: '36px', borderRadius: '6px', padding: '0 10px 0 30px', fontSize: '13px', outline: 'none', width: '100%',
  }
    ...
    <div className="space-y-5">
      ...
      <div className="flex border-b" style={{ borderColor: T.border }}>
        {[{ v: 'simulador', l: 'Simulador' }, { v: 'operacoes', l: 'Operações' }].map(tab => (
          <button key={tab.v} onClick={() => setActiveTab(tab.v as 'operacoes' | 'simulador')}
