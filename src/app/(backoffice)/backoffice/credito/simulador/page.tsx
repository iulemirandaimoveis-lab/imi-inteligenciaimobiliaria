                        ...
                        {[
                            {
                                ...
                                icon: Percent,
                                color: ltv <= 70 ? 'var(--success)' : ltv <= 80 ? '#FCD34D' : 'var(--error)',
                            ...
                            },
                            {
                                ...
                                icon: TrendingUp,
                                color: 'var(--info)', bg: 'rgba(96,165,250,0.1)',
                                    ...
                                    {[...amortization.slice(0, 12), ...(amortization.length > 24 ? [null] : []), ...amortization.slice(-12)].map((row, i) => {
                                        ...
                                        return (
                                            <tr key={row.month} style={{ borderTop: `1px solid ${T.border}` }} className="transition-colors hover:opacity-80">
                                                ...
                                                <td className="px-5 py-3 text-sm text-right" style={{ color: 'var(--success)', fontVariantNumeric: 'tabular-nums' }}>{fmt(row.principal)}</td>
                                                <td className="px-5 py-3 text-sm text-right" style={{ color: 'var(--error)', fontVariantNumeric: 'tabular-nums' }}>{fmt(row.interest)}</td>
