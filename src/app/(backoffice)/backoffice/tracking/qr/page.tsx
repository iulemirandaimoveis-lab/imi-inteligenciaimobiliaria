...
const SOURCES = [
    ...
    {
        value: 'placa', label: 'Placa Física', color: 'var(--warning)', bg: 'rgba(245,158,11,0.12)',
        icon: <MapPin size={18} />,
    },
    {
    ...
    {
        value: 'email', label: 'E-mail', color: 'var(--imi-gold-500)', bg: 'rgba(139,92,246,0.12)',
        ...
        <div className="space-y-6 max-w-[640px] mx-auto pb-12">
            ...
            <div className="rounded-lg overflow-hidden relative" style={{ background: '#0d1520', border: '1px solid rgba(255,255,255,0.07)' }}>
                ...
                <div className="flex flex-col items-center gap-5 p-8">
                    {/* QR */}
                    <div className="relative" style={{ background: 'var(--bg-surface)', borderRadius: 6, padding: 14, boxShadow: '0 12px 48px rgba(0,0,0,0.5)' }}>
                        {qrDataUrl ? (
                            <>
                                <img src={qrDataUrl} alt="QR Code" style={{ width: 168, height: 168, display: 'block', borderRadius: 6 }} />
                                <div style={{ position: 'absolute', bottom: 18, right: 18, background: '#486581', color: 'var(--text-inverse)', fontSize: 11, fontWeight: 900, padding: '2px 5px', borderRadius: 6, letterSpacing: '0.05em' }}>IMI</div>
                            </>
                        ) : (
                            <div style={{ width: 168, height: 168, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 8 }}>
                                        ...
                                        <div className="flex items-center gap-3 p-3.5">
                                            ...
                                            <div className="flex items-center gap-1.5 flex-shrink-0">
                                                ...
                                                <button
                                                    ...
                                                    title="Ver analytics"
                                                >
                                                    <Eye size={11} style={{ color: isExpanded ? 'var(--info)' : T.textMuted }} />
                                                </button>
