        ...
        <div className="p-6 lg:p-8 max-w-2xl">
            <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p className="text-xs" style={{ color: 'var(--bo-text-muted)' }}>Adicionar publicação à biblioteca</p>
                </div>
            </div>
                ...
                <div className="p-6 rounded-2xl space-y-5" style={{ background: 'var(--bo-card)', border: '1px solid var(--bo-border)' }}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            style={inputStyle}
                            placeholder="Ex: Guia do Investidor Imobiliário"
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className={inputClass}
                            style={inputStyle}
                            placeholder="guia-investidor-imobiliario"
                        />
                    </div>
                </div>
                ...
                <div className="p-6 rounded-2xl space-y-5" style={{ background: 'var(--bo-card)', border: '1px solid var(--bo-border)' }}>
                    ...
                    <div>
                        ...
                        <input
                            ...
                            onChange={e => set('back_cover_image', e.target.value)}
                            className={inputClass}
                            style={inputStyle}
                            placeholder="https://..."
                        />
