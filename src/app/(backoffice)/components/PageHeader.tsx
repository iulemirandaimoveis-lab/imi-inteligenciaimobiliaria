...
const badgeColors = {
    gold: { bg: 'rgba(196,157,91,0.10)', text: 'var(--bo-text-gold, #C49D5B)', border: 'rgba(196,157,91,0.2)' },
                            ...
                            {crumb.href ? (
                                <Link href={crumb.href}>
                                    <span
                                        ...
                                        onMouseEnter={e => (e.currentTarget.style.color = 'var(--bo-text-gold, #C49D5B)')}
