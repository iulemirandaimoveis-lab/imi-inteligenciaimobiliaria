...
const ACCENT_CONFIG: Record<string, { glow: string; iconBg: string; iconColor: string; border: string }> = {
  ...
  info:    { glow: 'rgba(96,165,250,0.06)',   iconBg: 'var(--info-bg)',          iconColor: 'var(--info)',             border: 'rgba(96,165,250,0.20)' },
  blue:    { glow: 'rgba(96,165,250,0.06)',   iconBg: 'var(--info-bg)',          iconColor: 'var(--info)',             border: 'rgba(96,165,250,0.20)' },
  ...
  cold:    { glow: 'rgba(96,165,250,0.06)',   iconBg: 'var(--info-bg)',          iconColor: 'var(--info)',             border: 'rgba(96,165,250,0.20)' },
