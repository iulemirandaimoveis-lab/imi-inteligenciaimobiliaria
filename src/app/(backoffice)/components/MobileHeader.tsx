                ...
                <div className="flex items-center justify-between h-14 px-4">
                    ...
                    <div className="flex items-center gap-2.5 min-w-0 flex-1">
                        <span
                            ...
                            style={{ color: '#C49D5B', fontFamily: "'Playfair Display', Georgia, serif" }}
                        >
                            IMI
                        </span>
                    ...
                    <div className="flex items-center gap-1">
                        ...
                        >
                            <Bell size={18} style={{ color: notifOpen ? '#C49D5B' : 'var(--bo-text-muted)' }} />
                            {unreadCount > 0 && (
                                <span
                            ...
                            <div className="overflow-y-auto" style={{ maxHeight: 'calc(70vh - 52px)' }}>
                                {notifications.length > 0 ? notifications.map(n => (
                                    <div
                                        ...
                                        style={{
                                            background: n.read ? 'transparent' : 'rgba(196,157,91,0.05)',
                                            borderBottom: '1px solid var(--bo-border)',
                                        }}
                                    >
                                        <div
                                            className="w-2 h-2 rounded-full mt-1.5 shrink-0"
                                            style={{ background: n.read ? 'transparent' : '#C49D5B' }}
                                        />
