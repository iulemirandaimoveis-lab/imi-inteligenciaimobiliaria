...
export const STATUS_CONFIG = {
  // ── Leads ──────────────────────────────────────────────
  novo:       { label: 'Novo',       color: 'var(--info)',      bg: 'var(--info-bg)',      dot: '#60a5fa' },
  quente:     { label: 'Quente',     color: 'var(--error)',        bg: 'var(--error-bg)',        dot: '#f87171' },
  morno:      { label: 'Morno',      color: 'var(--warning)',   bg: 'var(--warning-bg)',   dot: '#fbbf24' },
  frio:       { label: 'Frio',       color: 'var(--info)',       bg: 'var(--info-bg)',       dot: '#22d3ee' },
  convertido: { label: 'Convertido', color: 'var(--success)',   bg: 'var(--success-bg)',   dot: '#34d399' },
  perdido:    { label: 'Perdido',    color: 'var(--error)',     bg: 'var(--error-bg)',     dot: '#f87171' },
  ...
  won:         { label: 'Convertido',       color: 'var(--success)',   bg: 'var(--success-bg)',   dot: '#4ade80' },
  lost:        { label: 'Perdido',          color: 'var(--error)',     bg: 'var(--error-bg)',     dot: '#f87171' },
  new:         { label: 'Novo',             color: 'var(--info)',      bg: 'var(--info-bg)',      dot: '#60a5fa' },

  // ── Pipeline Kanban Stages ────────────────────────────────
  contatado:   { label: 'Contatado',   color: 'var(--warning)',   bg: 'var(--warning-bg)',   dot: '#f59e0b' },
  qualificado: { label: 'Qualificado', color: 'var(--success)',   bg: 'var(--success-bg)',   dot: '#10b981' },
  ...
  ganho:       { label: 'Ganho',       color: 'var(--success)',   bg: 'var(--success-bg)',   dot: '#22c55e' },
  ...
  // ── Contratos ──────────────────────────────────────────
  pendente:   { label: 'Pendente',   color: 'var(--warning)',   bg: 'var(--warning-bg)',   dot: '#fbbf24' },
  assinado:   { label: 'Assinado',   color: 'var(--success)',   bg: 'var(--success-bg)',   dot: '#34d399' },
  ...
  // ── Financeiro ─────────────────────────────────────────
  pago:       { label: 'Pago',       color: 'var(--success)',   bg: 'var(--success-bg)',   dot: '#34d399' },
  atrasado:   { label: 'Atrasado',   color: 'var(--error)',     bg: 'var(--error-bg)',     dot: '#f87171' },
  aberto:     { label: 'Em Aberto',  color: 'var(--warning)',   bg: 'var(--warning-bg)',   dot: '#fbbf24' },

  // ── Crédito ────────────────────────────────────────────
  em_analise:   { label: 'Em Análise',   color: 'var(--info)',      bg: 'var(--info-bg)',      dot: '#60a5fa' },
  aprovado:     { label: 'Aprovado',     color: 'var(--success)',   bg: 'var(--success-bg)',   dot: '#34d399' },
  negado:       { label: 'Negado',       color: 'var(--error)',     bg: 'var(--error-bg)',     dot: '#f87171' },
  ...
  rejected:     { label: 'Recusado',     color: 'var(--error)',     bg: 'var(--error-bg)',     dot: '#f87171' },
  analise:      { label: 'Em Análise',   color: 'var(--info)',      bg: 'var(--info-bg)',      dot: '#60a5fa' },
  ...
  concluida:        { label: 'Concluída',       color: 'var(--success)',   bg: 'var(--success-bg)',   dot: '#6BB87B' },
  cancelada:        { label: 'Cancelada',       color: 'var(--error)',     bg: 'var(--error-bg)',     dot: '#E57373' },
  aguardando_docs:  { label: 'Aguard. Docs',    color: '#a89ec4',            bg: 'rgba(168,158,196,0.12)', dot: '#a89ec4' },
  parcial:          { label: 'Parcial',         color: 'var(--warning)',   bg: 'var(--warning-bg)',   dot: '#fbbf24' },
  ...
  scheduled:  { label: 'Agendado',   color: 'var(--info)',      bg: 'var(--info-bg)',      dot: '#60a5fa' },
  error:      { label: 'Erro',       color: 'var(--error)',     bg: 'var(--error-bg)',     dot: '#f87171' },
