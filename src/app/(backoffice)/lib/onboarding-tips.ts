...
export const ONBOARDING_TIPS: ContextualTip[] = [
    ...
    },
    {
        ...
        description: 'Configure o WhatsApp Business para receber leads e enviar mensagens automáticas pelo IMI Connect.',
        position: 'bottom',
        order: 2,
    },
    {
        ...
        module: 'config',
        route: '/backoffice/integracoes',
        targetSelector: '[data-tour="google"]',
        title: 'Google Drive & Calendar',
        description: 'Conecte Google Drive para armazenar documentos e Google Calendar para sincronizar visitas.',
        position: 'bottom',
        order: 3,
    },
    {
        ...
        module: 'config',
        route: '/backoffice/integracoes',
        targetSelector: '[data-tour="email"]',
        title: 'Configurar Email',
        description: 'Ative Resend ou SMTP para enviar notificações, convites e propostas por email automaticamente.',
        position: 'bottom',
        order: 4,
    },
    {
