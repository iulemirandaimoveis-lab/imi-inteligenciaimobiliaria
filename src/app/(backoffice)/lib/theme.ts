...
export const T = {
    ...
    // Aliases (for legacy compat + module T consolidation)
    sub: 'var(--t2, #8E99AB)',
    // mobile-ui / form-ui / motor aliases
    navy: 'var(--bg, #050B14)',
    navyMid: 'var(--n, #0A1624)',
    navyCard: 'var(--n2, #0E1C30)',
    ...
    textSub: 'var(--t3, #4F5B6B)',
    green: 'var(--success)',
    red: 'var(--error)',
    blue: 'var(--info)',
    amber: 'var(--warning)',
    borderSoft: 'var(--bdr, rgba(255,255,255,.05))',
    borderHi: 'rgba(184,148,58,0.35)',
    raised: 'var(--n2, #0E1C30)',
    goldBg: 'rgba(184,148,58,0.08)',
    goldBgHi: 'rgba(184,148,58,0.14)',
    glassBase: 'color-mix(in srgb, var(--bg, #050B14) 85%, transparent)',
    // Accent
