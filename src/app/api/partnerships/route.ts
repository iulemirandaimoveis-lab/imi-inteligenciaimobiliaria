...
export async function GET(request: NextRequest) {
    try {
        ...
        let query = supabaseAdmin
            .from('partnerships')
            .select(
                'id, property_id, property_name, property_price, owner_id, owner_user_id, owner_name, partner_id, partner_user_id, partner_name, lead_name, status, commission_total_pct, commission_owner_pct, commission_partner_pct, sale_value, total_commission, total_messages, last_message_preview, last_message_at, unread_owner, unread_partner, proposed_at, responded_at, updated_at, expires_at',
                { count: 'exact' },
            )
