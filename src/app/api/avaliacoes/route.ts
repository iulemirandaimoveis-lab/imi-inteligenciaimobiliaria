...
export async function POST(request: NextRequest) {
    ...
    const payload: Record<string, any> = {
        ...
        cep: body.cep,
        area_privativa: body.area_privativa || body.areaPrivativa,
        area_total: body.area_total || body.areaTotal,
        quartos: body.quartos,
        banheiros: body.banheiros,
        vagas: body.vagas,
        andar: body.andar,
        ano_construcao: body.ano_construcao || body.anoConstrucao,
        padrao: body.padrao,
        ...
        cliente_cpf_cnpj: body.cliente_cpf_cnpj || body.clienteCpfCnpj || body.cliente_documento || body.clienteDocumento,
        ...
        prazo_entrega: body.prazo_entrega || body.prazoEntrega,
