...
// The full SVG viewBox (0,0)→(1200,821.86) maps to the bounding box below.
// ~572m wide × 444m tall (verified consistent with 383 lots of 289–693m² net area).
export const AB_GEO_CONFIG = {
  west:  -36.5136, // SVG x = 0
  east:  -36.5064, // SVG x = 1200
  north:  -8.9176, // SVG y = 0   (top of SVG = northern boundary)
  south:  -8.9220, // SVG y = 821.86 (bottom of SVG = southern boundary)
  centerLng: -36.5100,
  centerLat:  -8.9198,
  initialZoom: 16.5,
} as const;
